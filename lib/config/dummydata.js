...
User.find({}).remove(function() {
  ...
  Idea.find({}).remove(function() {
    Idea.create({
        ...
        ideaBranch.save();
        Idea.findById(ideaBranch.root, function (err, rootIdea) {
          rootIdea.branches.push(ideaBranch);
          rootIdea.save();
        });
        ...
        ideaBranch2.save();
        Idea.findById(ideaBranch2.root, function (err, rootIdea) {
          rootIdea.branches.push(ideaBranch2);
          rootIdea.save();
        });
