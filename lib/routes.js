...
module.exports = function(app) {
  ...
  app.delete('/api/ideas/:id/comment/:commentId', ideas.deleteComment);

  app.post('/api/users', users.create);
  app.put('/api/users', users.changePassword);
  app.put('/api/users/:id/idea', users.editIdeas);
  app.delete('/api/users/:id/idea', users.editIdeas);
  app.get('/api/users', users.readAll);
  app.get('/api/users/me', users.me);
  app.get('/api/users/:id', users.read);
  app.get('/api/users/:id/all', users.readWithIdeas);
